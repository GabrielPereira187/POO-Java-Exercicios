...
public class GuiFuncionario extends javax.swing.JFrame {
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addComponent(txtTaxaComissao, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addGap(18, 18, 18)
                        .addComponent(txtDtAdmissao, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
       ...
       if (cbxTipo.getSelectedIndex() == 0){
        ...
        cadastro.add(func); //insere o objeto no ArrayList        
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        cbxTipo.setEnabled(false);
        txtRegistro.setEnabled(false);
        cadastro.get(posFunc).setNome(txtNome.getText());
        cadastro.get(posFunc).setDtAdmissao(txtDtAdmissao.getText());
        cadastro.get(posFunc).setCargo(txtCargo.getText());
        if (cbxTipo.getSelectedIndex() == 0){
                ((FuncionarioHorista)cadastro.get(posFunc)).setValHorTrab(Double.parseDouble(txtValor.getText()));
            }else
               if (cbxTipo.getSelectedIndex() == 1){
               ((FuncionarioMensalista)cadastro.get(posFunc)).setValSalMin(Double.parseDouble(txtValor.getText()));
               }else{
                  ((FuncionarioComissionado)cadastro.get(posFunc)).setSalBase(Double.parseDouble(txtValor.getText()));
                  ((FuncionarioComissionado)cadastro.get(posFunc)).setTaxaComissao(Double.parseDouble(txtTaxaComissao.getText()));
               } 
